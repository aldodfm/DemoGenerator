...
namespace VstsRestAPI.Build
{
    public class BuildDefinition
    {
        ...
        public string[] CreateBuildDefinition(string json, string project)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var request = new HttpRequestMessage(method, _configuration.UriString + project + "/_apis/build/definitions?api-version=" + _configuration.VersionNumber) { Content = jsonContent };
